...
-- 日報
INSERT INTO daily_report_system.reports
  (report_date, title, content, employee_code, delete_flg, created_at, updated_at)
VALUES
  (CURRENT_DATE, '煌木　太郎の記載、タイトル',
   '煌木　太郎の記載、内容', '1', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

INSERT INTO daily_report_system.reports
  (report_date, title, content, employee_code, delete_flg, created_at, updated_at)
VALUES
  (CURRENT_DATE, '田中　太郎の記載、タイトル',
   '田中　太郎の記載、内容', '2', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
